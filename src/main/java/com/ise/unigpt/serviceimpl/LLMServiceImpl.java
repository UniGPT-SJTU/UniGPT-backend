...
public class LLMServiceImpl implements LLMService{
    ...
    public String generateResponse(History history, String userMessage, GenerateResponseOptions options) throws Exception {
        ...
        if(options.getCover()) {
            chats = chats.size() < 2 ? new ArrayList<>() : chats.subList(0, chats.size() - 2);
        }
        ...
        OpenAIRequestDTO dto = new OpenAIRequestDTO(modelName, messages, history.getLlmArgs().getTemperature());
