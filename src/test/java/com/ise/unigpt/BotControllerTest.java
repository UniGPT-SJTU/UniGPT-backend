...
public class BotControllerTest {
    ...
    void setUp() {
        ...
        Mockito.when(botService.getBotBriefInfo(Mockito.anyInt()))
                .thenReturn(botBriefInfoDTO);
        Mockito.when(botService.getBotDetailInfo(Mockito.anyInt(), Mockito.anyString()))
                .thenReturn(botDetailInfoDTO);

        Mockito.when(botService.getBotEditInfo(Mockito.anyInt(), Mockito.anyString()))
