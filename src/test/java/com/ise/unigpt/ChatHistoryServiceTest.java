...
public class ChatHistoryServiceTest {
    ...
    void testDeleteChats() throws Exception {
        ...
        Memory memory = TestMemoryFactory.createMemory();
        ...
        when(memoryRepository.findById(1)).thenReturn(java.util.Optional.of(memory));
    ...
    void testGetChats() throws Exception {
        ...
        List<Chat> chatList = Arrays.asList(
                new Chat(history, ChatType.USER, "content", true),
                new Chat(history, ChatType.BOT, "content", true));
